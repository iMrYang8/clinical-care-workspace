...
See [`docs/delivery/DEMO_RUNBOOK.md`](./DEMO_RUNBOOK.md) for the Scenario A-F
...
states are in [`docs/VOICE_PIPELINE.md`](../VOICE_PIPELINE.md).
...
[`docs/evidence/glance-benchmark.json`](../evidence/glance-benchmark.json).
