# Nightingale — architecture and product overview

**`main` · 3 September 2026 · synthetic/mock patient data only**

This is the deep architecture reference. For the submission brief — what the
clinic-scenario feedback changed, where this build fails, and which assumptions
did not survive — read [`TECHNICAL_BRIEF.md`](./TECHNICAL_BRIEF.md). For the
per-scenario coverage index, read
